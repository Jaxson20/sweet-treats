...
import { CREATE_VALENTINES_ORDER } from "../../../utils/mutations";
...
const ValentinesOrder = () => {
  ...
  const [ValentinesOrder, { error, data }] = useMutation(CREATE_VALENTINES_ORDER);
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const { data } = await ValentinesOrder({
        variables: {
      ...
      console.log("Order Created:", data.ValentinesOrder);
 
      await sendOrderConfirmationEmail(data.ValentinesOrder, formState.email);
  ...
  return (
    <Card className="ValentinesOrderCard">
...
export default ValentinesOrder;
